...
<Bars
  title="What is actually in the suite"
  rows={[
    { n: 'Assertions', v: 2700 },
    { n: 'Regression cases', v: 739 },
    { n: 'Scoring metrics', v: 250 }
  ]}
  note="Three different things, deliberately shown against each other. A case is one conversation. An
  assertion is one checkable claim about it, and roughly three and a half of them ride on every case,
  which is why a failure report has to name the assertion rather than the case."
/>
